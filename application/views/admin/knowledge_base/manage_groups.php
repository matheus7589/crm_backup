            ...
            <div class="col-md-12">
                ...
                <?php if(has_permission('knowledge_base','','create')){ ?>
                    <div class="panel-body _buttons">
                        <a href="#" onclick="new_kb_group(); return false;" class="btn btn-info"><?php echo _l('new_group'); ?></a>
                        <?php } ?>
                        <a href="<?php echo admin_url('knowledge_base'); ?>" class="btn btn-info mright5">Artigos</a>
                    </div>
                </div>
                <div class="panel_s">
                                ...
                                <table class="table dt-table">
                                    ...
                                    <tbody>
                                        ...
                                        <?php if(has_permission('knowledge_base','','edit')){ ?>
                                            <a href="#" onclick="edit_kb_group(this,<?php echo $group['groupid']; ?>); return false" data-name="<?php echo $group['name']; ?>" data-color="<?php echo $group['color']; ?>" data-description="<?php echo clear_textarea_breaks($group['description']); ?>" data-order="<?php echo $group['group_order']; ?>" data-active="<?php echo $group['active']; ?>" <?php echo "data-departments='".json_encode(explode(",",$group['departments']))."'"; ?> class="btn btn-default btn-icon"><i class="fa fa-pencil-square-o"></i></a>
                                        <?php } ?>
