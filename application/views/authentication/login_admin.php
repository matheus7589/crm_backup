...
if(PAINEL == INORTE){
    $selector = 'admin-login-background';
}else{
    $selector = 'login-background';
}

?>
<body class="login_admin"<?php if(is_rtl()){ echo ' dir="rtl"'; } ?> style="background-color:<?php echo get_custom_style_values("admin", $selector);?>">
 <div class="container">
  <div class="row">
