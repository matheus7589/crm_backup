...
class Staff extends Admin_controller
{
    ...
    public function member($id = '')
    {
        ...
        if(is_numeric($id))
            $data['tickets'] = $this->db->query("SELECT ticketid,subject,status,statuscolor,tblclients.company FROM tbltickets INNER JOIN tblclients ON tblclients.userid = tbltickets.userid JOIN tblticketstatus ON tblticketstatus.ticketstatusid = tbltickets.status WHERE assigned = ".$id)->result_array();
