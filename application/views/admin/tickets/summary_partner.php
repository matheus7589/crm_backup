...
<div class="col-md-12">
    <h4 class="text-success no-margin"><?php echo _l('tickets_summary'); ?></h4>
</div>
<?php
$where = '';
if (!is_admin()) {
...
foreach($statuses as $status){
    ...
    <div class="col-md-2 col-xs-6 mbot15 border-right">
        <a href="#" data-cview="ticket_status_<?php echo $status['ticketstatusid']; ?>" onclick="dt_custom_view('ticket_status_<?php echo $status['ticketstatusid']; ?>','.tickets-partner','ticket_status_<?php echo $status['ticketstatusid']; ?>',true, true); return false;">
