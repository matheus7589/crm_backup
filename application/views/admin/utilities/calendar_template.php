<div class="modal fade _event" id="newEventModal">
  ...
  <div class="modal-footer">
    <button type="button" class="btn btn-default" id="closebntcalendar" data-dismiss="modal"><?php echo _l('close'); ?></button>
      <?php if(isset($sub)){?>
          <button type="button" onClick="create_event()" class="btn btn-info"><?php echo _l('submit'); ?></button>
      <?php }else {?>
