							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<?php echo render_input('telefone','Telefone',$ticket->phonenumber,'number',array('disabled'=>true)); ?>
										</div>
										<div class="col-md-6">
											<?php echo render_input('fantasia','Nome Fantasia',$ticket->company,'text',array('disabled'=>true)); ?>
										</div>
									</div>
