      ...
      <div class="lead-view<?php if(!isset($lead)){echo ' hide';} ?>">
         <div class="col-md-4 col-xs-12 mtop15">
            ...
            <?php if(PAINEL == INORTE) { ?>
                <p class="text-muted lead-field-heading"><?php echo "Interessado"; ?></p>
                <p class="bold font-medium-xs"><?php echo (isset($lead) && $lead->is_interessado != '' && $lead->is_interessado == 0 ? "Não interessado" : "Interessado") ?></p>
                <p class="text-muted lead-field-heading"><?php echo "Celular"; ?></p>
                <p class="bold font-medium-xs"><?php echo (isset($lead) && $lead->celular != '' ? $lead->celular : '-') ?></p>
                <p class="text-muted lead-field-heading"><?php echo "Whatsapp"; ?></p>
                <p class="bold font-medium-xs"><?php echo (isset($lead) && $lead->whatsapp != '' ? $lead->whatsapp : '-') ?></p>
                <p class="text-muted lead-field-heading"><?php echo "Nome do Contato"; ?></p>
                <p class="bold font-medium-xs"><?php echo (isset($lead) && $lead->contato_nome != '' ? $lead->contato_nome : '-') ?></p>
            <?php } ?>
            <p class="text-muted lead-field-heading"><?php echo "Próximo Contato"; ?></p>
            <p class="bold font-medium-xs"><?php echo (isset($lead) && $lead->nextcontact != '' ? _dt($lead->nextcontact) : '-') ?></p>
         </div>
         <div class="col-md-4 col-xs-12 mtop15">
            <div class="lead-info-heading">
               <h4 class="no-margin font-medium-xs bold">
      ...
      <div class="lead-edit<?php if(isset($lead)){echo ' hide';} ?>">
         ...
         <div class="col-md-12">
            <div class="form-group">
             ...
             <div class="form-group">
                 <div class="checkbox checkbox-primary<?php if(isset($lead)){echo ' hide';} ?><?php if(isset($lead) && (is_lead_creator($lead->id) || is_admin())){echo ' lead-edit';} ?>">
                     <input type="checkbox" name="is_interessado" <?php if(isset($lead)){if($lead->is_interessado == 1){echo 'checked';}}; ?> id="lead_interessado">
                     <label for="lead_interessado"><?php echo "Interessado"; ?></label>
                 </div>
             </div>
             <?php } ?>
         </div>
         <div class="col-md-6">
            ...
            <?php echo render_input('name','lead_add_edit_name',$value); ?>
             <?php if(PAINEL == INORTE) {?>
                <?php $value = (isset($lead->celular) ? $lead->celular : ''); ?>
                <?php echo render_input('celular','Celular',$value); ?>
                <?php $value = (isset($lead->whatsapp) ? $lead->whatsapp : ''); ?>
                <?php echo render_input('whatsapp','Whatsapp',$value); ?>
             <?php }else{ ?>
            ...
            <?php if(PAINEL == INORTE){ ?>
             <?php $value = (isset($lead->contato_nome) ? $lead->contato_nome : ''); ?>
             <?php echo render_input('contato_nome','Nome do Contato',$value); ?>
             <?php } ?>
         </div>
         <div class="col-md-6">
...
<!--                  --><?php //if(PAINEL == INORTE){ ?>
                      <div>
                          <?php echo render_datetime_input('nextcontact','Próximo Contato','',array()); ?>
                      </div>
<!--                  --><?php //} ?>
                  <?php } else { ?>
                      <?php if(PAINEL == INORTE){ ?>
                          <div>
                              <?php echo render_datetime_input('nextcontact','Próximo Contato', _dt($lead->nextcontact), array()); ?>
                          </div>
                      <?php } ?>
   ...
   <div class="lead-edit<?php if(isset($lead)){echo ' hide';} ?>">
      <hr />
      <button type="submit" id="btn-newlead" class="btn btn-info pull-right" onClick="setTimeout(function() {$('#btn-newlead')[0].disabled = true;}, 200); setTimeout(function() {$('#btn-newlead')[0].disabled = false; }, 2000);"><?php echo _l('submit'); ?></button>
