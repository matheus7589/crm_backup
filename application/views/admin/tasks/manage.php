               ...
               <div class="panel-body _buttons">
                  <div class="row">
                     <div class="col-md-8">
                        ...
                        <?php if(is_admin()){ ?>
                            <a class='btn btn-danger  mleft10 pull-left' href='<?php echo ciroute("parar-tarefas.create")?>'>
                               Parada Automática
                            </a>
                        <?php } ?>
                     </div>
                     <div class="col-md-4">
                      ...
                      <div class="col-md-4">
                          <a target="_blank" href="<?php echo admin_url('painel/desenvolvimento'); ?>" class="btn btn-success mtop10">Painel Desenvolvimento</a>
                          <a target="_blank" href="<?php echo admin_url('tasks/config_painel'); ?>" class="btn btn-success mtop10">Config. Painel Desenvolvimento</a>
                      </div>
                      <?php } ?>
