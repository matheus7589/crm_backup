<?php echo form_open_multipart('clients/open_ticket', array('id' => 'open-new-ticket-form')); ?>
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                        ...
                                        <select data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"
                                            ...
                                            <?php foreach ($departments as $department) { ?>
                                                <?php if ($department['departmentid'] == 1) { ?>
                                                    <option selected="selected" value="<?php echo $department['departmentid']; ?>" <?php echo set_select('department', $department['departmentid'], (count($departments) == 1 ? true : false)); ?>>
                                                <?php } else { ?>
                                                    <option disabled="disabled" value="<?php echo $department['departmentid']; ?>" <?php echo set_select('department', $department['departmentid'], (count($departments) == 1 ? true : false)); ?>>
                                                <?php } ?>
                                ...
                                <div class="col-md-6 <?php echo (PAINEL == INORTE) ? 'hide' : ''; ?>">
                                    <div class="form-group">
                                        ...
                                        <select data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>"
                                            ...
                                            <?php foreach ($priorities as $priority) { ?>
                                                <?php if ($priority['priorityid'] == 3) { ?>
                                                    <option selected="selected"
                                                            value="<?php echo $priority['priorityid']; ?>" <?php echo set_select('priority', $priority['priorityid']); ?>><?php echo ticket_priority_translate($priority['priorityid']); ?></option>
                                                <?php } else { ?>
                ...
                <div class="panel-footer attachments_area">
                    <div class="row attachments">
                        <div class="attachment">
                           ...
                           <button class="btn btn-success add_more_attachments p8-half" data-ticket="true"
        ...
        <div class="col-md-12 text-center mtop20">
            <button type="submit" class="btn btn-info" data-form="#open-new-ticket-form" autocomplete="off"
