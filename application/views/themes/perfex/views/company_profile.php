...
<!--                    --><?php //echo render_custom_fields( 'customers',$client->userid,array('show_on_client_portal'=>1)); ?>
                      <div class="form-group">
                            <?php echo render_select('model_certificate', $model_certificates, ['id', 'name'], 'Certificado Modelo', $client->model_certificate, array('disabled'=>true)); ?>
                      </div>
                      <div class="form-group">
                            <?php echo render_select('issuing_certificate', $issuing_certificates, ['id', 'name'], 'Certificado Emissor', $client->issuing_certificate, array('disabled'=>true)); ?>
                      </div>
                      <div class="form-group">
                          <?php echo render_date_input('validate_certificate', 'Certificado Validade: ', _d($client->validate_certificate), array('disabled'=>true)); ?>
                      </div>
                      <div class="form-group">
                            <?php echo render_input('phonenumber', 'Contato', $contact->phonenumber, '', array('disabled'=>true)); ?>
                      </div>
                      <div class="form-group">
                          <?php echo render_input('cellphone', 'Celular', $client->cellphone, '', array('disabled'=>true)); ?>
                      </div>
                      <div class="form-group">
                          <?php echo render_input('cnpj_or_cpf', 'CPF_CNPJ', $client->cnpj_or_cpf, '', array('disabled'=>true)); ?>
                      </div>
                      <div class="form-group">
                          <?php echo render_select('partner_id', $partners, array('partner_id', 'firstname'), 'Parceiro', $client->partner_id, array('disabled'=>true), array(), '', '', true); ?>
                      </div>
                </div>
