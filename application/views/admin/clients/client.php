         ...
         <div class="col-md-3">
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <?php } ?>
                  <h4 class="customer-heading-profile bold">#<?php echo $client->userid . ' ' . $title; ?></h4>
...
<script>
    ...
    $(function mascara()
    {
        ...
        $('input[name="cellphone"]').inputmask({"mask": "([0]99) 9999[9]-9999", greedy: false, skipOptionalPartCharacter: " "});
        $('input[name="zip"]').mask("99999-999");
        $('input[name="shipping_zip"]').mask("99999-999");
        $('input[name="billing_zip"]').mask("99999-999");
        $('input[name="phonenumber"]').inputmask({"mask": "([0]99) 9999[9]-9999", greedy: false, skipOptionalPartCharacter: " "});
        $('input[name="custom_fields[customers][3]"]').inputmask({"mask": "([0]99) 9999[9]-9999", greedy: false, skipOptionalPartCharacter: " "});
    });
