   ...
   <div class="modal-dialog modal-lg" role="document">
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
           ...
           <?php echo render_input('cnpj_or_cpf','CNPJ', '', 'text', array('required' => 'true')); ?>
           <?php echo render_input('cod_empresa','Código da Empresa', 0); ?>
           ...
           <?php
                if(is_admin())
                    echo render_select('partner_id', $partners, array('partner_id', 'firstname'), 'Parceiro', '', array(), array(), '', '', false);
           ?>
