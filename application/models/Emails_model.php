...
class Emails_model extends CRM_Model
{
    ...
    {
        $teplate_is_active = $this->db->select("active")->where("slug",$template_slug)->get("tblemailtemplates")->row()->active;
        if($teplate_is_active) {
        ...
        {
            logActivity("Email não enviado. Template está desativado.");
            return false;
        }
    }
